...
test "simple image histogram" {
    var h: *Histogram = try Histogram.init(testing.allocator);
    defer h.deinit(testing.allocator);

    var i: *Image = try Image.init(testing.allocator, image_data, image_width, image_height);
...
test "transparent image historgram" {
    ...
    var i: *Image = try Image.init(testing.allocator, &dc, image_width, image_height);
    defer i.deinit(testing.allocator);
